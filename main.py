...
def main():
    ...
    DatabaseManager.extract_products_for_replace(initialization_database.products_table, category_number)
    ...
    """products = DatabaseManager.products_from_database(initialization_database.products_table)
    print(DatabaseManager.product_choice(initialization_database.products_table, product_choice, products))"""
